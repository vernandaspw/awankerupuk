...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                @include('includes.supplier.topbar')
                @yield('content')
            </div>
...
<head>
    ...
    <meta name="description" content="">
    <meta name="author" content="">
    <title>Login Supplier TCA</title>
    <link rel="shortcut icon" href="{{  asset('assets/awankerupuk.jpg') }}" type="image/x-icon">
    <link href="{{ asset('vendor/sbadmin/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-5 m-4">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Back Supplier TCA!</h1>
                                        <h3 class="h4 text-gray-900 mb-4">Supplier Masuk</h3>

                                    </div>
                                    <form class="user" method="POST" action="{{url('supplier/login')}}">
                                        @csrf
                                        @method('POST')
