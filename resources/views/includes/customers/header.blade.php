            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{ url('/') }}"><span style="color: orange"> <b>&nbsp;TCA</b></span></a>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a class="{{ request()->is('pesanan') ? 'active' : '' }}" href="{{ url('pesanan') }}"><i
                                        class="fa fa-crosshairs"></i> Pesanan saya</a>
                            </li>
                            <li><a class="{{ request()->is('akun') ? 'active' : '' }}" href="{{ url('akun') }}"><i
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="{{ url('/') }}" class="{{ request()->is('/') ? 'active' : '' }}">Beranda</a>
                            </li>
