...
<div class="card shadow m-4">
    <div class="card-header">
        <h1 class="h3 mb-2 text-gray-800">Tambah metode pembayaran untuk perusahaan</h1>
    </div>

    <div class="card-body">
        <span class="text-danger">*untuk metode pembayaran cod/tunai, colum AN dan No rek tidak perlu diisi, tulis colum
            keterangan 'pembayaran ditempat'</span>
        <form method="POST" action="{{ url('supplier/metode/store') }}">
            @method('POST')
            @csrf
            ...
            <br>
            <a href="{{ url('supplier/metode') }}" class="btn btn-secondary" type="button"
