...
<div class="card shadow m-4">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered" id="dynamicTable">
            ...
            <form method="POST" action="{{ url('supplier/bahan/beriharga', $detail->id) }}">
                @method('put')
                @csrf
                <tr>
                    ...
                    <td> <button type="submit" class="btn btn-success text-white">Beri harga</button></td>
                </tr>
            </form>
            @endforeach
        </table>
        ...
        <br>
        <a href="{{ url('supplier/bahan') }}" class="btn btn-secondary" type="button" data-dismiss="modal">Kembali</a>
